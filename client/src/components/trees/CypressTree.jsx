...
const TIERS = [
  { cy:480, rx:52, ry:40,  pRange:[0.08,0.28] },
  { cy:420, rx:46, ry:45,  pRange:[0.14,0.33] },
  { cy:355, rx:40, ry:50,  pRange:[0.20,0.38] },
  { cy:285, rx:34, ry:52,  pRange:[0.26,0.44] },
  { cy:210, rx:28, ry:55,  pRange:[0.32,0.50] },
  { cy:140, rx:22, ry:50,  pRange:[0.38,0.56] },
  { cy:80,  rx:16, ry:45,  pRange:[0.44,0.62] },
  { cy:30,  rx:10, ry:35,  pRange:[0.50,0.68] },
];
  ...
  return (
    <>
      ...
      <path d="M300,520 C299,420 300,320 299,220 C298,160 299,100 300,30"
        stroke="#2a1206" strokeWidth={trunkW * 0.44} strokeLinecap="round" fill="none" opacity="0.15"
      ...
      <path d="M301,520 C300,420 301,320 300,220 C299,160 300,100 301,30"
        stroke="#6a4828" strokeWidth={Math.max(2, trunkW * 0.3)} strokeLinecap="round" fill="none" opacity="0.4"
        strokeDasharray="500" strokeDashoffset={500*(1-trP)} style={{ transition:dashTr }}/>
